"""
Main entry point for the Your Book Mentor application.
...
def main():
    ...
    st.title("📚 Your Book Mentor")
    st.markdown("""
    Welcome to Your Book Mentor! Upload your documents or input text,
